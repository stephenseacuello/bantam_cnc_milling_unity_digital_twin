...
namespace MiracleTwin.UI
{
    ...
    public class DashboardOverlay : MonoBehaviour
    {
        ...
        private void BindElements()
        {
            ...
            fxLabel = root.Q<Label>("fx-value");
            fyLabel = root.Q<Label>("fy-value");
            fzLabel = root.Q<Label>("fz-value");
            wearLabel = root.Q<Label>("wear-pct-value");
            vbLabel = root.Q<Label>("vb-value");
            ...
            availLabel = root.Q<Label>("avail-value");
            perfLabel = root.Q<Label>("perf-value");
            qualLabel = root.Q<Label>("qual-value");
